const PostSummaryItem = (post) => {
    return (`
        <li class="list-group-item pt-0 pb-0">
            <div class="row">
                <div class="card-body col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-8 wd-override-padding pe-0">
                ...
                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-4 d-flex justify-content-end align-items-center wd-override-padding ps-0">
